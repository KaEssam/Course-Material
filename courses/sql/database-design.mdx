...
description: 'A comprehensive guide to database systems, Entity-Relationship modeling, and the complete database development lifecycle with practical examples and case studies.'
---
...
- **Dependent** → Dependent Table (with Employee SSN + Dependent Name as composite key)

#### 3. Relationships → Foreign Keys or Junction Tables

**One-to-Many Relationships:**

- Department manages Projects → Project table gets DepartmentID foreign key
- Employee works for Department → Employee table gets DepartmentID foreign key
- Employee supervises Employee → Employee table gets SupervisorSSN foreign key

**Many-to-Many Relationships:**

- Employee works on Projects → Create WorksOn junction table with (EmployeeSSN, ProjectNumber, Hours)
