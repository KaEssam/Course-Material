---
title: 'Session 1 - Database Design Fundamentals'
...
Try to create an ER diagram for this company system based on the requirements above. Identify:

1. **Entities** and their attributes
2. **Relationships** and their cardinalities
